...
<div class="heading-dark"><a href="https://mft.musings.it/" target="_blank" rel="noreferrer"> by musings.it </a></div>
...
<div class="col">
  ...
  <div> It is the js Object with the files that substitute your original document favicon(s) when the user leaves your page to open a new tab in the browser. The new files will substitute those normally set in the <head> section of your page like this:
    <div>
    <pre>
    <code>
...
<div class="col">
    ...
    <div>Array of strings that contains the alternate text to show if mftTitleBlink is true in visible and hidden state respectively.
        Accepted values: strings for each array value. Short notation as string for both values (ex. 'blinking text') is accepted.
        Default value: ['', '']. How to set:</div>
        <div>
            <pre><code>$.mFancyTitle({
...
$.mFancyTitle({
	...
	mftMissYouFavicon: {
		...
		'icon': 'images/favicon/heart.png',
		'shortcut icon': 'images/favicon/heart.png'
	} // new favicons: they will be visible when the user leaves your page and open another tab in the browser
});
</script>
</body>
