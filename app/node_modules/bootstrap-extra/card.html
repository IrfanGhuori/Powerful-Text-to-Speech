...
<head>
    ...
    <script>
      WebFont.load({
        ...
        custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['plugin/css/fonts.min.css']},
        active: function() {
...
<div class="container">
  <a href="https://getbootstrap.com/docs/4.4/components/card/" target="_blank" rel="noreferrer"> more examples </a><br>
  <br><br><br>
</div>
