...
<body>
<div class="side-bar shadow-s-1" >
<div class="display-7" > Bootstrap v4 Updated Vresion</div>
</div>
<div class="container">
<br>
<div class="card">
<div class="card-header display-6">Use Color Name for background-color</div>
<div class="card-body">
    
<pre>
<code>
Simple Example: &lt;div class="set-colors" data-setcolor="tomato">&lt;/div>
It works with all elements: &lt;nav class="navbar navbar-expand-lg navbar-light set-colors" data-setcolor="azure"> 
</code>
</pre>
<table id="colors_table" class="table table-hover" >
<thead>
<tr>
...
<td rowspan="16"><a class="external" href="https://www.w3.org/TR/CSS1/" hreflang="en" lang="en" rel="noopener" title="The 'CSS Level&nbsp;1' specification">CSS Level&nbsp;1</a></td>
...
<tr>
<td><a class="external" href="https://www.w3.org/TR/CSS2/" hreflang="en" lang="en" rel="noopener" title="The 'CSS Level&nbsp;2 (Revision&nbsp;1)' specification">CSS Level&nbsp;2 (Revision&nbsp;1)</a></td>
<td style="text-align: center;"><code>orange</code></td>
<td><code>#ffa500</code></td>
<td style="background: orange;"></td>
</tr>
<tr>
<td rowspan="130"><a class="external" href="https://drafts.csswg.org/css-color-3/" hreflang="en" lang="en" rel="noopener" title="The 'CSS Color Module Level&nbsp;3' specification">CSS Color Module Level&nbsp;3</a></td>
...
<tr>
<td><a class="external" href="https://drafts.csswg.org/css-color/" hreflang="en" lang="en" rel="noopener" title="The 'CSS Color Module Level&nbsp;4' specification">CSS Color Module Level&nbsp;4</a></td>
<td style="text-align: center;"><a class="external" href="https://en.wikipedia.org/wiki/Eric_A._Meyer#Personal_life" rel="noopener"><code>rebeccapurple</code></a></td>
...
<div class="container"><div class="card-footer "><div class="float-right"> <a style="text-decoration: none;" href="mailto:IrfanGhuori@yandex.com"> Think big, I'll make it possible :) </a></div></div> <br><br> </div>
</div>
